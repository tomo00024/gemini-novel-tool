...
<style>
	...
	.chat-bubble { position: relative; max-width: 90%; padding: 0.5rem 1rem; border-radius: 1rem; background-color: #f0f0f0; }
	...
	.floating-menu { position: absolute; top: -0.5rem; right: 1rem; display: flex; gap: 0.25rem; background-color: white; border-radius: 9999px; padding: 0.25rem; box-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1); opacity: 0; visibility: hidden; transform: translateY(4px); transition: all 0.2s ease-in-out; }
	...
	.textarea { background-color: white; border-color: #d1d5db; color: black; padding: 0.5rem; border-radius: 0.25rem; resize: none; overflow-y: hidden; min-height: 4rem; }
	.chat-bubble-primary .textarea { background-color: #1d4ed8; border-color: #3b82f6; color: white; }
