<script lang="ts">
	export let variant: 'primary' | 'secondary' | 'danger' | 'menu' | 'blue' = 'secondary';
	...
	const baseStyles =
		'cursor-pointer transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-50 font-semibold';
