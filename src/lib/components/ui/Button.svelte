<script lang="ts">
	export let variant: 'primary' | 'danger' | 'menu' = 'primary';
	...
	const baseStyles =
		'cursor-pointer transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-70 font-semibold';
