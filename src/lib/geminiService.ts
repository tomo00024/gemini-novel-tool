...
import { callGeminiApiWithOneStepFC, type OneStepFCChatResponse } from './oneStepFC/geminiClient.oneStepFC';
 ...
 */
export function isOneStepResponse(response: StandardChatResponse | OneStepFCChatResponse): response is OneStepFCChatResponse {
...
export async function callGeminiApi(
    ...
    userInput: string
        ...
        case 'oneStepFC':
            ...
            return callGeminiApiWithOneStepFC(apiKey, context, userInput);
        ...
        case 'twoStepFC':
            ...
            return callGeminiApiOnClient(apiKey, context, userInput);
